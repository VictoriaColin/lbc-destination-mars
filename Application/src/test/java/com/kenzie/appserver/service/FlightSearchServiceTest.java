...
class FlightSearchServiceTest {
    ...
    @Test
    void noFlightsFound_arrivalLocationDidNotMatch(){
        LocalDate date = LocalDate.parse("2003-07-01");
        ...
        assertThrows(ItemNotFoundException.class,
                ()-> subject.findFlights(date,departureLocation,arrivalLocation));
    }

    @Test
    void noFlightsFound_datesDidNotMatch(){
        LocalDate date = LocalDate.parse("2003-07-01");
        LocalDate date2 =  LocalDate.parse("2003-07-02");
        String departureLocation = "CA";
        String arrivalLocation = "MARS";
    ...
    @Test
    void noFlightsFound_destinationDidNotMatch(){
        LocalDate date = LocalDate.parse("2003-07-01");
        LocalDate date2 =  LocalDate.parse("2003-07-02");
        String departureLocation = "CA";
        String arrivalLocation = "MARS";
